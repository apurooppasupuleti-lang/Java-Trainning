...
public class FunctionalExamples {
    ...
    public static void comparatorDemo() {
        ...
        int result1 = comp.compare(10, 20);
        int result2 = comp.compare(20, 10);
        int result3 = comp.compare(10, 10);

        System.out.println("Comparator (10,20): " + result1);
        System.out.println("Comparator (20,10): " + result2);
        System.out.println("Comparator (10,10): " + result3);
    }
}